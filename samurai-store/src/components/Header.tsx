...
export default function Header({ user }: HeaderProps) {
 ...
 // メニュー外のクリックを検知し、メニューを閉じる
  ...
  <ul className="inline-flex divide-x divide-gray-300 list-none overflow-hidden rounded-sm">
    <li>
      <Link href="/" className="block w-[120px] py-3 hover:bg-gray-200">
        ホーム
      </Link>
    </li>
    <li>
      <Link href="/products" className="block w-[120px] py-3 hover:bg-gray-200">
        商品一覧
      </Link>
    </li>
    <li>
      <Link href="/contact" className="block w-[120px] py-3 hover:bg-gray-200">
        お問い合わせ
      </Link>
    </li>
  </ul>
