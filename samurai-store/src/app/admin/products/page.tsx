  ...
  return (
    <>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex justify-end mb-4 gap-2"> {/* ✅ gap-2 を追加 */}
          {/* ✅ お問い合わせ一覧ボタンを追加（緑色） */}
          <Link href="/admin/inquiries" className="bg-gray-400 hover:bg-gray-500 text-white py-2 px-4 rounded-sm font-semibold">
            お問い合わせ一覧
          </Link>
